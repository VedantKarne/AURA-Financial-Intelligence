...
- 🗄️ **Quantitative vs. Qualitative Decoupling**: AURA routes hard financial metrics to a structured SQLite database (`get_kpis`) while sending qualitative analysis to the vector engine (`rag_search`), protecting against the severe hallucination risks of treating numbers as raw text.
