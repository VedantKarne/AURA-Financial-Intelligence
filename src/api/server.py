...
async def chat_endpoint(req: ChatRequest):
    ...
    full_query = (
        ...
        "TABLE CITATION SAFETY: NEVER place citations like [Apple | Q3 | 2023 | summary] inside table cells — the pipe characters break table formatting. Inside table cells use [1], [2], [3] numeric refs only, then list the full citation key below the table. "
