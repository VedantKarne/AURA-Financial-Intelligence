...
- TABLE CITATION SAFETY: NEVER place inline citations like [Apple | Q3 | 2023 | summary] inside a markdown table cell — the pipe characters will break the table. Instead, inside table cells use numeric shorthand refs like [1], [2], [3], and then place a Citation Key section directly below the table listing: [1] = [Apple | Q3 | 2023 | summary], etc.
